...
if __name__ == '__main__':
    ...
    if train == 1:
        ...
        print('shape of test errors', test_errors.shape)
        n, bins, patches = plt.hist(test_errors.flatten(), 40, density=True, facecolor='#7777bb')

        plt.xlabel('Voltage Percent Error')
        plt.ylabel('Probability Density')
        #plt.title('Probability Density of SVR Model Voltage Errors')
        ...
        """
        n, bins, patches = plt.hist(x=test_errors, bins=50, facecolor='g')  #, color='#0504aa'),
